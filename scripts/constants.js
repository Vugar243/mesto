...
export const infoTitle = document.querySelector('.profile-info__title');
export const infoSubtitle = document.querySelector('.profile-info__subtitle');
export const inputName = document.querySelector('.popup__input_type_name');
export const inputDescription = document.querySelector('.popup__input_type_description');
export const profileAddButton = document.querySelector('.profile__add-button');
export const addingCard = document.querySelector('.popup_adding-card');
